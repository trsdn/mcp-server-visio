...
- C# / .NET 10 + PowerPoint COM automation via `dynamic` + `VisioMcp.ComInterop`, MCP SDK (`ModelContextProtocol`), `System.Text.Json`, CLI via `Spectre.Console.Cli` (001-rename-queries-tables)
