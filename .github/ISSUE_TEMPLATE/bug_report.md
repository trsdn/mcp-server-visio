...
**For MCP Server:**
- Tool name: [e.g., page, shape, text, cell, layer, stencil, export, window, docproperty, shapealign, file]
...
## Sample File
If possible, attach a sample Visio file that reproduces the issue (remove sensitive data).
