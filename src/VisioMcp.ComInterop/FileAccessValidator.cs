...
public static class FileAccessValidator
{
    ...
    // IRM/AIP-protected Visio files are stored as OLE2 containers with an EncryptedPackage
    ...
    /// encryption; <c>false</c> for standard ZIP-based .vsdx/.vsdm files or if the file
    /// cannot be read.
    /// </returns>
    ...
    /// This is a fast OS-level check that doesn't require launching Visio.
    /// </summary>
    ...
    public static InvalidOperationException CreateFileLockedError(string filePath, Exception innerException)
    {
        return new InvalidOperationException(
            ...
            "VisioMcp requires exclusive access to documents during operations.",
            innerException);
    }
}
