...
```powershell
# When modifying VisioSession.cs or VisioBatch.cs
...
.\src\VisioMcp.CLI\bin\Release\net9.0-windows\visiocli.exe --version
```
...
3. **Visio is replaced** - Use a different presentation engine with .NET bindings
